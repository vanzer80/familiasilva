...
| `CHAR-003` | Patrícia Silva | Patrícia | [Ficha](oficiais/CHAR-003-PATRICIA-SILVA.md) | [Canônica](oficiais/personalidades/PATRICIA-PERSONALIDADE.md) | `APROVADO / CANON VISUAL` (V01; V02 pendente) |
...
As sete imagens MASTER do elenco inicial estão versionadas em [../assets/personagens/mestres/](../assets/personagens/mestres/) e catalogadas, com SHA-256 e proveniência, em [MANIFESTO-MESTRES.md](../assets/personagens/mestres/MANIFESTO-MESTRES.md), pela [DEC-014](../docs/DECISOES.md#dec-014). Exceção: a interpretação visual mais recente de Patrícia ("V02") segue `PENDENTE DE IMPORTAÇÃO DA FONTE APROVADA` — o arquivo hoje versionado é a V01.
