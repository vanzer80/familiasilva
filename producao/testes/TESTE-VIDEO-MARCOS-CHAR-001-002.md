# TEST-VIDEO-CHAR-001-002 — Marcos

- **Data:** `2026-08-28`
- **Personagem:** Marcos Silva (`CHAR-001`)
- **Rodada:** validação da MASTER V02 PHOTOREALISTIC em vídeo — apresentação individual
- **MASTER usada:** `IMG-CHAR-001-MARCOS-MASTER-V02-PHOTOREALISTIC.jpeg` (current canon — [DEC-015](../../docs/DECISOES.md#dec-015))
