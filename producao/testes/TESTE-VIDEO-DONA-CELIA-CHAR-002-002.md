# TEST-VIDEO-CHAR-002-002 — Dona Célia

- **Data:** `2026-08-28`
- **Personagem:** Dona Célia (`CHAR-002`)
- **Rodada:** validação da MASTER V02 PHOTOREALISTIC em vídeo — apresentação individual
- **MASTER usada:** `IMG-CHAR-002-DONA-CELIA-MASTER-V02-PHOTOREALISTIC.jpeg` (current canon — [DEC-015](../../docs/DECISOES.md#dec-015))
