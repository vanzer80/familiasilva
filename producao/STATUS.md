...
- Auditoria física dos 7 vídeos de apresentação: `PARCIAL — BLOQUEADA POR ACESSO À FONTE BINÁRIA` em `2026-08-29`. Os arquivos históricos `marcos.mp4`, `celia.mp4`, `patricia.mp4`, `antonio.mp4`, `beto.mp4`, `carol.mp4` e `dudu.mp4`, registrados em `G:\Meu Drive\familia_silva\videos\`, têm pareamento candidato documentado com os sete testes aprovados e nomenclatura alvo `VID-CHAR-XXX-APRESENTACAO-V01.mp4`, mas ainda não foram confirmados por inspeção do conteúdo nem renomeados fisicamente. Ver [AUDITORIA-VIDEOS-APRESENTACAO-2026-08-29.md](../docs/auditorias/AUDITORIA-VIDEOS-APRESENTACAO-2026-08-29.md).
