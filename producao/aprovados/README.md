...
Materiais e padrões com aprovação explícita. Cada registro declara exatamente qual dimensão foi aprovada.

| Registro | Aprovação |
| --- | --- |
| [PADRAO-RENDERING-VIDEO-001.md](PADRAO-RENDERING-VIDEO-001.md) | rendering canônico da série |
